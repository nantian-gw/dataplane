...
async fn http1_route_inflight_budget_fast_fails_second_request() {
    ...
    let runtime = RuntimeOptions {
        enable_ipv6: false,
        admission: aeg_observability::HttpAdmissionOptions {
            route_inflight_limit: 1,
            ..aeg_observability::HttpAdmissionOptions::default()
        },
    ...
    assert_eq!(overload_snapshot.http_rejected_route_total, 1);
}
