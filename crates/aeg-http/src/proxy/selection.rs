...
use super::{
    ...
    context::{route_kind_name, SelectedBackendConfig, UpstreamPeerAddress},
};
use aeg_observability::TrafficTopology;
...
fn selected_backend_config_from_parts(
    ...
    let use_http2 = matches!(selected.route_kind, aeg_ir::RouteKind::Grpc)
