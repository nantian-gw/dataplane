...
use aeg_ir::{BackendTlsConfig, Snapshot};
...
fn parse_client_cert_key(secret: &aeg_ir::SecretMaterial) -> pingora::Result<Arc<CertKey>> {
...
fn cached_client_cert_key(secret: &aeg_ir::SecretMaterial) -> pingora::Result<Arc<CertKey>> {
