...
pub(super) fn append_inventory_metrics(out: &mut String, ctx: &MetricsContext) {
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_http3_configured",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_session_persistence_active",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_session_persistence_ephemeral_secret",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_tcp_global_connections_current",
    ...
    append_labeled_gauge_map(
        out,
        "aether_gateway_dataplane_tcp_listener_connections_current",
