...
pub(super) fn append_protection_metrics(out: &mut String, ctx: &MetricsContext) {
    ...
    append_labeled_counter_map(
        out,
        "nantian_gateway_dataplane_http_overload_rejected_listener_total",
    ...
    append_labeled_counter_map(
        out,
        "nantian_gateway_dataplane_http_overload_rejected_route_total",
    ...
    append_labeled_counter_map(
        out,
        "nantian_gateway_dataplane_udp_overload_rejected_listener_total",
    ...
    append_labeled_counter_map(
        out,
        "nantian_gateway_dataplane_http_circuit_breaker_rejected_backend_total",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_global_enabled",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_global_burst",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_listener_enabled",
        "1 if the per-listener HTTP rate limit scope is enabled, 0 otherwise.",
        u64::from(rate_limit.listener.enabled),
    );
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_listener_requests_per_second",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_listener_burst",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_route_enabled",
        "1 if the per-route HTTP rate limit scope is enabled, 0 otherwise.",
        u64::from(rate_limit.route.enabled),
    );
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_route_requests_per_second",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_http_rate_limit_route_burst",
        "Configured per-route HTTP request rate limit burst across HTTP, HTTPS, and gRPC traffic.",
        u64::from(rate_limit.route.burst),
    );
    append_labeled_gauge_map(
        out,
        "nantian_gateway_dataplane_http_rate_limit_route_available_tokens",
    ...
    append_counter(
        out,
        "nantian_gateway_dataplane_http_rate_limit_allowed_total",
    ...
    append_labeled_counter_map(
        out,
        "nantian_gateway_dataplane_http_rate_limit_rejected_listener_total",
    ...
    append_counter(
        out,
        "nantian_gateway_dataplane_http_retry_budget_allowed_total",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_endpoint_runtime_tracked_current",
