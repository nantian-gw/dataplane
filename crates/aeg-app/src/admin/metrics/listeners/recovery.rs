...
pub(super) fn append_listener_recovery_metrics(
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_has_ever_failed_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_recovered_from_failure_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_recovered_from_failure_http_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_recovered_from_failure_stream_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_recovered_from_failure_tls_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_recovered_from_failure_none_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_failure_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_failure_http_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_failure_stream_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_failure_tls_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_failure_none_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_current_snapshot_failure_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_current_snapshot_failure_http_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_current_snapshot_failure_stream_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_current_snapshot_failure_tls_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_current_snapshot_failure_none_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_historical_failure_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_historical_failure_http_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_historical_failure_stream_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_historical_failure_tls_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_unrecovered_historical_failure_none_count",
    ...
    append_gauge(
        out,
        "aether_gateway_dataplane_listener_failure_recovery_severity_level",
