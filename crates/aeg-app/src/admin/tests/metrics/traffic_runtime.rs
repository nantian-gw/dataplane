...
fn render_metrics_exposes_traffic_counters() {
    ...
    state.traffic.observe(TrafficObservation {
        ...
        upstream_connect_latency_ms_buckets: {
            let mut buckets = [0; aeg_observability::UPSTREAM_CONNECT_LATENCY_MS_BUCKET_COUNT];
            buckets[aeg_observability::upstream_connect_latency_ms_bucket_index(11)] = 1;
            buckets
        },
    ...
    state.traffic.observe(TrafficObservation {
        ...
        upstream_connect_latency_ms_buckets: [0;
            aeg_observability::UPSTREAM_CONNECT_LATENCY_MS_BUCKET_COUNT],
