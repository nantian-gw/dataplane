...
use super::{
    ...
    runtime::{
        ...
        snapshot_requires_stream_runtime, snapshot_requires_tls_runtime, RuntimePlaneState,
    },
};
...
pub(crate) fn build_listener_runtime_status(
    listener: &Listener,
    snapshot: &Snapshot,
    runtime: &aeg_observability::RuntimeStatsSnapshot,
) -> ListenerRuntimeStatus {
    let empty_failures: &[aeg_observability::RuntimeListenerFailure] = &[];
    let empty_progress = aeg_observability::RuntimeListenerProgress::default();
