...
fn runtime_tuning_fans_out_to_http_and_stream_runtime_options() {
    ...
    cfg.runtime_tuning = RuntimeTuningConfig {
        ...
        downstream_tcp_keepalive: aeg_config::TcpKeepaliveConfig {
            enabled: true,
            idle_ms: 65_000,
            interval_ms: 12_000,
            probe_count: 5,
...
upstream_tcp_keepalive: aeg_config::TcpKeepaliveConfig {
            enabled: true,
            idle_ms: 45_000,
            interval_ms: 10_000,
            probe_count: 4,
        ...
        http_cache: aeg_config::HttpCacheConfig::default(),
    };
