...
pub(crate) use matching::{
    best_stream_rule_match_with_tls_mode, default_http_path_match, filters_without_request_mirror,
    has_non_backend_http_filter, hostname_matches, is_grpc_request, matches_grpc_rule,
    matches_http_rule, normalize_host_ref, normalize_http_path_match, parse_grpc_path, GrpcPath,
};
