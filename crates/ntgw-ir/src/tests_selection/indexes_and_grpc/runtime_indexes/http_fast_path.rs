...
fn http_fast_path_selects_same_simple_backend_as_generic_http_selection() {
    ...
    assert_eq!(fast.route_name, generic.route_name);
    assert_eq!(fast.route_namespace, generic.route_namespace);
    assert_eq!(fast.rule_index, generic.rule_index);
    assert_eq!(fast.listener_name, generic.listener_name);
    assert_eq!(fast.listener_protocol, generic.listener_protocol);
    assert_eq!(fast.backend_name, generic.backend_name);
