use aeg_ir::SelectedBackend;
use aeg_observability::{access_log_enabled_for_route, epoch_millis, AccessLogOptions};
...
mod tests {
    ...
    use aeg_ir::{BackendEndpoint, RouteKind, SelectedBackend};
    use aeg_observability::AccessLogOptions;
