...
fn render_metrics_exposes_traffic_counters() {
    ...
    assert!(
        metrics.contains("nantian_gateway_dataplane_listener_convergence_blocked_http_count 1")
    );
    ...
    assert!(
        metrics.contains("nantian_gateway_dataplane_listener_convergence_blocked_none_count 0")
    );
    ...
    assert!(
        metrics.contains("nantian_gateway_dataplane_listener_awaiting_current_attempt_count 0")
    );
    assert!(
        metrics
    ...
    assert!(
        metrics.contains("nantian_gateway_dataplane_listener_serving_current_snapshot_count 0")
    );
    assert!(
    ...
    assert!(
        metrics.contains(
            "nantian_gateway_dataplane_listener_serving_state_last_good_rejected_count 0"
        )
    );
    assert!(
        metrics
    ...
    assert!(
        metrics.contains("nantian_gateway_dataplane_listener_unrecovered_failure_http_count 1")
    );
    ...
    assert!(
        metrics.contains("nantian_gateway_dataplane_listener_unrecovered_failure_none_count 0")
    );
    assert!(
        metrics.contains("nantian_gateway_dataplane_listener_risk_pending_unrecovered_count 0")
    );
    assert!(
