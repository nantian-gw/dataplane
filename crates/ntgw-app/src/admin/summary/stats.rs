...
pub(super) fn traffic_retry_rate(traffic: &ntgw_observability::TrafficSnapshot) -> f64 {
...
pub(super) fn traffic_failover_success_rate(traffic: &ntgw_observability::TrafficSnapshot) -> f64 {
