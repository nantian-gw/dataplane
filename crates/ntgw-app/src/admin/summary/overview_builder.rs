...
pub(super) struct SummaryValueInputs<'a> {
    pub(super) snapshot: &'a ntgw_ir::Snapshot,
    pub(super) runtime: &'a ntgw_observability::RuntimeStatsSnapshot,
    pub(super) traffic: &'a ntgw_observability::TrafficSnapshot,
    pub(super) xds: &'a ntgw_xds::ClientStatsSnapshot,
    pub(super) overload: &'a ntgw_observability::OverloadSnapshot,
...
pub(super) fn build_summary_document(
    ...
    let http3_available = ntgw_http::http3_available();
