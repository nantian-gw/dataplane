...
pub(super) fn append_listener_serving_metrics(out: &mut String, counts: &ListenerMetricCounts) {
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_listener_serving_current_snapshot_count",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_listener_serving_state_none_count",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_listener_serving_state_current_accepted_count",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_listener_serving_state_current_retained_count",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_listener_serving_last_good_snapshot_count",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_listener_serving_state_last_good_rejected_count",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_listener_serving_state_last_good_stale_count",
