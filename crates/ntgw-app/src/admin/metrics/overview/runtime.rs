...
pub(super) fn append_runtime_metrics(out: &mut String, ctx: &MetricsContext) {
    ...
    append_counter(
        out,
        "nantian_gateway_dataplane_runtime_http_listener_reload_failures_total",
    ...
    append_counter(
        out,
        "nantian_gateway_dataplane_runtime_http_tls_asset_reuses_total",
    ...
    append_counter(
        out,
        "nantian_gateway_dataplane_runtime_stream_listener_reload_failures_total",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_runtime_http_current_rejected",
    ...
    append_gauge(
        out,
        "nantian_gateway_dataplane_runtime_stream_current_rejected",
