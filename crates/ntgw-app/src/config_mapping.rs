...
pub(crate) fn to_http_capacity_options(cfg: &HttpCapacityConfig) -> ntgw_http::HttpCapacityOptions {
    ntgw_http::HttpCapacityOptions {
...
pub(crate) fn to_http_runtime_options(cfg: &DataPlaneConfig) -> ntgw_http::RuntimeOptions {
    let http_capacity = cfg.runtime_tuning.http_capacity();

    ntgw_http::RuntimeOptions {
        ...
        cache: ntgw_http::CacheManager::new(ntgw_http::CacheOptions::from(
...
pub(crate) fn to_stream_runtime_options(cfg: &DataPlaneConfig) -> ntgw_stream::RuntimeOptions {
    ntgw_stream::RuntimeOptions {
