...
pub(crate) fn run_traffic_observe_reused_topology(
    iterations: u32,
    config: aeg_observability::bench::TrafficStatsBenchConfig,
) -> Result<ScenarioReport> {
    run_traffic_observe_path(
        "traffic_observe_reused_topology",
        iterations,
        config,
        aeg_observability::bench::TrafficStatsTopologyMode::ReusedTopology,
    )
}
...
pub(crate) fn run_traffic_observe_no_route(
    ...
    run_traffic_observe_path(
        ...
        iterations,
        config,
        aeg_observability::bench::TrafficStatsTopologyMode::NoRoute,
    )
}

pub(crate) fn run_traffic_observe_backend_topology_4_shards(
    iterations: u32,
    mut config: aeg_observability::bench::TrafficStatsBenchConfig,
) -> Result<ScenarioReport> {
    ...
    run_traffic_observe_path(
        ...
        iterations,
        config,
        aeg_observability::bench::TrafficStatsTopologyMode::BackendTopology,
    )
}
...
fn run_traffic_observe_path(
    ...
    iterations: u32,
    config: aeg_observability::bench::TrafficStatsBenchConfig,
    topology_mode: aeg_observability::bench::TrafficStatsTopologyMode,
) -> Result<ScenarioReport> {
    let fixture = aeg_observability::bench::TrafficStatsFixture::build(config, topology_mode);
