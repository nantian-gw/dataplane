...
fn default_bench_config(iterations: u32) -> BenchConfig {
    BenchConfig {
        iterations,
        snapshot: aeg_ir::bench::SnapshotBenchConfig::default(),
        tls_rotation: aeg_http::runtime_bench::TlsRotationBenchConfig::default(),
        xds_apply: aeg_xds::bench::ApplyBenchConfig::default(),
        request_meta: aeg_http::bench::RequestMetaBuildBenchConfig::default(),
        filter_chain: aeg_http::bench::FilterChainBenchConfig::default(),
        session_persistence: aeg_http::bench::SessionBenchConfig::default(),
        access_log: aeg_observability::bench::AccessLogBenchConfig::default(),
        traffic_stats: aeg_observability::bench::TrafficStatsBenchConfig::default(),
        http_capacity: aeg_http::runtime_bench::HttpCapacityMatrixBenchConfig::default(),
        stream: aeg_stream::bench::StreamBenchConfig::default(),
    }
}
...
fn request_fast_path_bench_report_contains_selection_details() {
    let report = crate::scenarios::run_request_fast_path_selection(
        4,
        aeg_http::bench::RequestMetaBuildBenchConfig::default(),
    )
...
fn traffic_stats_bench_report_contains_topology_details() {
    let report = crate::scenarios::run_traffic_observe_backend_topology_4_shards(
        4,
        aeg_observability::bench::TrafficStatsBenchConfig::default(),
    )
...
fn http_capacity_matrix_report_contains_parallelism_rows() {
    let report = crate::scenarios::run_http_capacity_matrix(
        2,
        aeg_http::runtime_bench::HttpCapacityMatrixBenchConfig::default(),
    )
...
fn stream_bench_reports_tcp_udp_tuning_details() {
    let config = aeg_stream::bench::StreamBenchConfig::default();
