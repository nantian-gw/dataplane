...
pub struct RequestContext {
    ...
    pub(crate) access_log_request_headers: BTreeMap<Arc<str>, String>,
    pub(crate) access_log_sent_response_headers: BTreeMap<Arc<str>, String>,
    pub(crate) access_log_upstream_response_headers: BTreeMap<Arc<str>, String>,
