...
fn sample_fast_selected_backend_config(address: &str, port: u16) -> SelectedBackendConfig {
    let selected_backend = ntgw_ir::SelectedBackend { route_policy: None,
        route_kind: RouteKind::Http,
        route_name: "orders".to_string(),
        route_namespace: "default".to_string(),
        rule_index: Some(0),
    ...
    let snapshot = ntgw_ir::Snapshot::default();
    ...
    SelectedBackendConfig {
        ...
        traffic_topology: ntgw_observability::TrafficTopology::from_parts(
            "default/gw/http",
            "Http",
            "default",
            "orders",
