...
fn listener_replace_context<'a>(
    ...
    runtime_stats: &'a ntgw_observability::SharedRuntimeStats,
    traffic: SharedTrafficStats,
    overload: ntgw_observability::SharedOverloadStats,
    ...
    Ok(ListenerReplaceContext {
        ...
        runtime_stats,
        traffic,
        admission: ntgw_observability::HttpAdmissionController::new(Default::default(), overload),
