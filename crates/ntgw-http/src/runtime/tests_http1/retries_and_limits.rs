...
async fn route_rate_limit_fast_fails_second_request_with_429() {
    ...
    let runtime = RuntimeOptions {
        enable_ipv6: false,
        rate_limit: ntgw_observability::HttpRateLimitOptions {
            route_requests_per_second: 1,
            route_burst: 1,
            ..ntgw_observability::HttpRateLimitOptions::default()
        },
...
async fn backend_circuit_breaker_fast_fails_second_request_with_503() {
    ...
    let runtime = RuntimeOptions {
        enable_ipv6: false,
        circuit_breaker: ntgw_observability::HttpCircuitBreakerOptions {
